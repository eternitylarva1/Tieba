...
public class Strike extends CustomCard {
    ...
    public static final String ID = ModHelper.makePath("Soul_R");
    ...
    public void upgrade() {
        if (!this.upgraded) {
            ...
            this.upgradeMagicNumber(3); // 将该卡牌的伤害提高3点。
...
addToBot(new ApplyPowerAction(p,p,new ChangePlayerPower(p,3,"Defect")));
